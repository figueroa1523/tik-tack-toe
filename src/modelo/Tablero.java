...
public class Tablero extends JPanel{
    ...
    public void cambiarEstilos(TipoImagen jugadorAct){
        if(jugadorAct == TipoImagen.CIRCULO){
            FormTikTackToe.imgJugadorEquis.setRuta(Ruta.JUGADORAUXILIAR);
            FormTikTackToe.imgJugadorEquis.repaint();
            FormTikTackToe.nombreJugadorEquis.setForeground(new Color(240,240,240,100));
            
            FormTikTackToe.imgJugadorCirculo.setRuta(Ruta.JUGADORCIRCULO);
            FormTikTackToe.imgJugadorCirculo.repaint();
            FormTikTackToe.nombreJugadorCirculo.setForeground(new Color(255,200,255));
        }else if(jugadorActual == TipoImagen.EQUIS){
            FormTikTackToe.imgJugadorCirculo.setRuta(Ruta.JUGADORAUXILIAR);
            FormTikTackToe.imgJugadorCirculo.repaint();
            FormTikTackToe.nombreJugadorCirculo.setForeground(new Color(240,240,240,100));
            
            FormTikTackToe.imgJugadorEquis.setRuta(Ruta.JUGADOREQUIS);
            FormTikTackToe.imgJugadorEquis.repaint();
            FormTikTackToe.nombreJugadorEquis.setForeground(new Color(180,232,255));
        }
    }
    ...
    public void reiniciarTablero(TipoImagen ganador){
        desactivarCuadro(false);
        borrarImagenes();
        cuadroFrontal.setTipoImagen(null);
        if(ganador == TipoImagen.EQUIS){
            int puntajeNuevo = Integer.parseInt(FormTikTackToe.puntajeEquis.getText())+1;
            FormTikTackToe.puntajeEquis.setText(String.valueOf(puntajeNuevo));
        }
        else if(ganador == TipoImagen.CIRCULO){
            int puntajeNuevo = Integer.parseInt(FormTikTackToe.puntajeCirculo.getText())+1;
            FormTikTackToe.puntajeCirculo.setText(String.valueOf(puntajeNuevo));
        }
    ...
    public void desactivarCuadro(boolean valor){
    ...
    public void setAnchoCI(int anchiCI) {
        this.anchoCI = anchiCI;
    }
