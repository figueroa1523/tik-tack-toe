...
public class FormResultado extends javax.swing.JFrame {
    ...
    public FormResultado(TipoImagen jugadorGanador, Tablero tablero) {
        ...
        if(jugadorGanador==TipoImagen.EQUIS){
            ...
            lblNombre.setText(FormTikTackToe.nombreJugadorEquis.getText());
        }
        else if(jugadorGanador==TipoImagen.CIRCULO){
            imgIzquierda.setRuta(Ruta.JUGADORCIRCULO);
            imgDerecha.setRuta(Ruta.CIRCULO);
            lblNombre.setText(FormTikTackToe.nombreJugadorCirculo.getText());
        }
    ...
    private void initComponents() {
        ...
        imgIzquierda.setBounds(60, 90, 40, 40);

        imgDerecha.setText("imagen1");
        imgDerecha.setRuta("/resources/Equis.png");
        panelFondo.add(imgDerecha);
        imgDerecha.setBounds(320, 90, 40, 40);

        lblNombre.setFont(new java.awt.Font("Maiandra GD", 1, 20)); // NOI18N
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelFondo, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
